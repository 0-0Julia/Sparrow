<%@ Page Title="" Language="C#" MasterPageFile="Site1.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="Birds_Guide.AddUser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <section style="width:70%; align-items:center;font-size: 15px;">
           ...
           <form class="form" runat="server">
               <%=message %>
                <label>Username:</label>
                    <input class="input" type="text" id="username" name="username" onchange="inputusername()" size="50"/>
              ...
              <br />  <label>
               ...
               <fieldset>
      <legend> Upload Profile Image </legend><p style="color:gray; font-size:small;">optional</p>
               <asp:FileUpload id="image" name="image" runat="server"/>
                ...
                <label>
                    <input class="input" type="number" placeholder="Accsess Key*" id="accesskey" name="accesskey" required="required" style="width:45%;"/>
                </label>
                <label style="color:snow">
                    <input class="btn add" type="submit" id="Add" name="Add" value="Add""/>
