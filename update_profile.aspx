<%@ Page Title="" Language="C#" MasterPageFile="Site1.Master" AutoEventWireup="true" CodeBehind="update_profile.aspx.cs" Inherits="Birds_Guide.update_profile" %>
...
<header onload="selected()">
        <h1>Update Your info</h1>
    </header>

          <section style="width:70%; align-items:center;"> 
...
<div class="profile-pic">
  ...
  <label>  <asp:FileUpload runat="server" class="Pinput" id="image"  onchange="loadFile(event)"/> </label>
  <img class="Pimg" src="pictures/profilePic/<%=Imgpath %>" id="output" width="200" />
</div>
                <label>Username:</label>
                    <input class="input" type="text" id="username" name="username" value="<%=username %>"onchange="inputusername()"/>
                            <p id="UsernameP" class="pStyle" style="margin-right:20px"></p> 
                   <label>Email:</label>
                        <input class="input" type="email" id="email" name="email" value="<%=email %>" onchange="inputEmail()"/>
                               <p id="EmailP" class="pStyle"></p> 

                    <label>Phone:</label>
                        <input class="input" type="text" id="phone" name="phone" value="<%=phone %>" onchange="inputPhone()"/>
                               <p  id="PhoneP" class="pStyle"></p> 

               <label>Password:</label>
                        <input class="input" type="password" id="password" name="password" value="<%=password %>" onchange="inputpassword()"/>
               ...
               show password<input type="checkbox" onclick="passwordTransform()"> 
                ...
                <select id="gender" name="gender">
                 ...
                 <select id="country" name="country">
                   ...
                   <label>
                        <input class="btn upd" type="submit" id="Update"  style="width:200px;" name="Update" value="Update" onclick="return click()"/>                   
                        <input class="btn del"  type="submit" id="delete" style="width:200px;" name="delete" value="Delete Account"/>
                   </label>
                <br />
            </form>   
    <script>
